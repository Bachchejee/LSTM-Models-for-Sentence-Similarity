...
def check(num1,num2):
    if num1 == num2:
        return 'The sentence is similar'
    else:
        return 'The sentence is not similar'

def main ():
    html_temp = """
        <div style="padding:10px; background-color:darkblue; ">
            <h2 style="color:white;text-align:center;"> Siamese LSTM Models for Sentence Similarity </h2>
        </div>
    """
    ...
    sentence1 += st.text_input('Input sentence')
    sentence2 += st.text_input('Input 2nd sentence')
